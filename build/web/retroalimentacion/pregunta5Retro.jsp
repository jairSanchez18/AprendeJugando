...
<%
    ...
    session.setAttribute("JuegoFinalizado", 10);
        ...
        <div class="col p-5">
            ...
            <div class="d-grid">
                <form action="../temas.jsp">
                    <button type="submit" class=" btn btn-success w-100">Finalizar Test</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="container w-75 bg-white mt-xl-5 rounded shadow ">
    <div class="row align-items-stretch">
        <div class="col p-5">
            ...
            <div class="d-grid">
                <form action="../temas.jsp">
                    <button type="submit" class=" btn btn-danger w-100">Finalizar Test</button>
                </form>
            </div>
        </div>
    </div>
